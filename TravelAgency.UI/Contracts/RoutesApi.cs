namespace TravelAgency.UI.Contracts
{
    public class RoutesApi
    {
        ...
        {
            public const string GetByStatus = Base + "/auctionsStatus/{status}";
            public const string GetByLast = Base + "/auctionsLast/{status}";
            public const string Create = Base + "/auctions";
            public const string GetById = Base + "/auctions/{auctionId}";
            public const string Update = Base + "/auctions";
            public const string Buy = Base + "/auctions/buy";
            public const string Delete = Base + "/auctions/{auctionId}";
        }
